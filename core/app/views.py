...
class CreateTaskView(LoginRequiredMixin, CreateView):
    ...
    model = (
        ToDoApp  # Specifies the model that this view interacts with
    )
    fields = (
        "author",
        "content",
    )  # Defines the fields available in the task creation form
...
class UpdateTaskView(LoginRequiredMixin, UpdateView):
    ...
    fields = (
        "author",
        "content",
    )  # Defines the fields available for editing
