...
class CustomUserAdmin(UserAdmin):
    ...
    fieldsets = (
        (
            "Authentication",
            {  # Section containing authentication-related fields
                "fields": (
                    "email",
                    "password",
                )  # Displays email and password fields in the admin panel
            },
        ),
        (
            "Permissions",
            {  # Section for managing user permissions
                "fields": (
                    "is_staff",
                    "is_superuser",
                    "is_active",
                    "is_verified",
                )  # Controls access levels within the application
            },
        ),
        (
            "Group Permissions",
            {  # Section for assigning groups and specific user permissions
                "fields": (
                    "groups",
                    "user_permissions",
        ...
        (
            ...
            {  # Section for tracking login activity
                "fields": (
                    "last_login",
                )  # Displays the last login timestamp for users
            },
        ),
    )
    ...
    add_fieldsets = (
        (
            None,
            {
                "classes": (
                    "wide",
                ),  # Applies styling for a clearer form layout
                "fields": (
                    "email",
                    "password1",
                    "password2",
                    "is_staff",  # Defines required fields for user creation
                    "is_active",
                    "is_superuser",
                ),
            },
