...
schema_view = get_schema_view(
   openapi.Info(
      ...
      contact=openapi.Contact(email="contact@snippets.local"),  # API contact information
      license=openapi.License(name="BSD License"),  # API license details
   ),
...
urlpatterns = [
    ...
    path('swagger/output.json', schema_view.without_ui(cache_timeout=0), name='schema-json'),  # JSON schema output
